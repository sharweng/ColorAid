...
const styles = StyleSheet.create({
  ...
  retakeText: { color: '#fff', fontSize: Typography.size.base, fontWeight: '600' },
  bottomColor: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: Spacing.md },
  bottomSwatch: { width: 48, height: 48, borderRadius: Radius.md, borderWidth: 1, borderColor: 'rgba(255,255,255,0.15)' },
  bottomColorName: { color: '#fff', fontSize: Typography.size.lg, fontWeight: '700' },
  bottomColorHex: { color: 'rgba(255,255,255,0.65)', fontSize: Typography.size.sm },
